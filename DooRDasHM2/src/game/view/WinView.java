...
public class WinView extends VBox {
	...
	public WinView(String winnerName, String winnerRole, int finalEnergy) {
		this.setSpacing(30);
		...
		Label details = new Label(winnerName + " (" + winnerRole + ") won with " + finalEnergy + " energy!");
		...
		this.getChildren().addAll(winlab, details, restartBtn);
